...
/**
 * This is the model class for table "main_story".
 *
 * The followings are the available columns in table 'main_story':
 ...
 */
class MainStory extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('title, url, menu_img_url, main_img_url, main_message, delete_flag, update_timestamp', 'required'),
			array('affiliate_group_id', 'numerical', 'integerOnly'=>true),
			...
			array('story_id, title, url, menu_img_url, main_img_url, main_message, affiliate_group_id, delete_flag, update_timestamp, create_timestamp', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MainStory the static model class
	 */
